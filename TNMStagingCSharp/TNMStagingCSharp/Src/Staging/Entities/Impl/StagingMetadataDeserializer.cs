...
{
    public class StagingMetadataDeserializer
    {
        /*
        ...
        public override StagingMetadata deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException 
        {
