...
To download [the beta version of staging library - TNMStagingCSharp_v24.zip](https://github.com/imsweb/staging-client-csharp/releases/download/v2.4-beta/TNMStagingCSharp_v24.zip).
