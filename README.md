...
To download [the beta version of staging library - TNMStagingCSharp_v30.zip](https://github.com/imsweb/staging-client-csharp/releases/download/v3.0-beta/TNMStagingCSharp_v30.zip).
