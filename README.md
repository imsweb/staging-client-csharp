...
To download [the beta version of staging library - TNMStagingCSharp_v12.zip](https://github.com/imsweb/staging-client-csharp/releases/download/v1.1-beta/TNMStagingCSharp_v12.zip).
