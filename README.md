...
To download [the beta version of staging library - TNMStagingCSharp_v28.zip](https://github.com/imsweb/staging-client-csharp/releases/download/v2.8-beta/TNMStagingCSharp_v28.zip).
