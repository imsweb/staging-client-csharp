...
| Version | Release                                                                       | Algorithm ZIP                                                                                                        |
|---------|-------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| 3.2     | [4.8](https://github.com/imsweb/staging-client-csharp/releases/tag/v4.8beta) | [eod_public-3.2.zip](https://github.com/imsweb/staging-client-csharp/releases/download/v4.8beta/eod_public-3.2.zip) |
