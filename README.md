...
To download [the beta version of staging library - TNMStagingCSharp_v21.zip](https://github.com/imsweb/staging-client-csharp/releases/download/v2.1-beta/TNMStagingCSharp_v21.zip).
